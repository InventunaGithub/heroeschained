...
public class MockController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for (int i = 0; i < Characters.transform.childCount; i++)
        {
            ...
            if(i >= (Characters.transform.childCount / 2))
            {
                ...
                King2.Team.Add(new Hero(hero.Name, hero.HeroID, hero.BaseHealth, hero.Strength, hero.Dexterity, hero.Intelligence, hero.Vitality, hero.Range, hero.HeroSkills));
            ...
            {
                Hero hero = mockHeroes[i % mockHeroes.Count];
                King1.Team.Add(new Hero(hero.Name, hero.HeroID, hero.BaseHealth, hero.Strength, hero.Dexterity, hero.Intelligence, hero.Vitality, hero.Range, hero.HeroSkills));
    ...
    void scriptableObjectToNormal()
    {
        ...
        {
            mockHeroes.Add(new Hero(hero.Name, hero.HeroID, hero.BaseHealth, hero.Strength, hero.Dexterity, hero.Intelligence, hero.Vitality, hero.Range, hero.HeroSkills));
        }
    }
}
